...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountOperation.stamp'
        db.add_column(u'cashflow_accountoperation', 'stamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountOperation.stamp'
        db.delete_column(u'cashflow_accountoperation', 'stamp')
